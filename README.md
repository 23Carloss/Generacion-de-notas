...
1. Crear una DB en MySql llamada tikcetsMantenimiento
...
7. Ir a la ruta game-maintenance-frontend y ejecutar los siguientes comandos
  npm run dev
  h + enter
  o + enter este comando abrirá la aplicación en el navegador
